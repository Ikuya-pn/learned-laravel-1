                          ...
                          <div class="lg:w-1/2 md:w-2/3 mx-auto">
                            <form method="post" action="{{route('owner.products.store')}}">
                              ...
                              <div class="-m-2">
                                ...
                                <div class="p-2 w-full">
                                    <div class="relative">
                                      <label for="quantity" class="leading-7 text-sm text-gray-600">初期在庫数</label><span class="text-xs ml-2 text-gray-600">※0~500で指定してください。</span>
                                ...
                                <div class="p-2 w-full mt-3">
                                    <div class="relative flex justify-around">
                                      <div><input type="radio" name="is_selling" checked value="1">販売中</div>
                                      <div><input type="radio" name="is_selling"  value="2">停止中</div>
                                    </div>
                                </div>
                                <div class="mt-6 p-2 w-full flex justify-around items-center">
