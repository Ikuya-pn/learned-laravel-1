                              ...
                              <div class="flex flex-wrap -m-2">
                                ...
                                <div class="p-2 w-full">
                                  ...
                                  <div class="mt-5 w-1/2">
                                    <x-thumbnail :filename="$shop->filename" type="shops" class="rounded-lg" />
                                  </div>              
                                </div>
                                <div class="p-2 w-full">
                                ...
                                <div class="mt-4 p-2 w-full flex justify-around items-center">
                                  <a href="{{route('owner.shops.index')}}" class="border-b border-gray-500 text-gray-600 hover:text-gray-400">戻る</a>
